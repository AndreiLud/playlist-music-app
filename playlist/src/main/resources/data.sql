-- ---------------------------------------------------------------------------
-- Play Your List - criacao do schema e carga inicial
-- As tabelas sao removidas na ordem inversa das dependencias (chaves
-- estrangeiras) para que o script possa ser reexecutado sem erros.
-- ---------------------------------------------------------------------------
